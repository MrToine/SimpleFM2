...
class Validator
{
    ...
    public function slug(string $key): self
    {
        ...
        if (is_null($value)) {
            /**
             * On r�cup�re la valeur et si elle  est nulle, alors on retourne quand m�me la
             * r�gle pour �viter une erreur au cas o� le slug n'existe pas.
             * */
            return $this;
        }
    ...
    /**
     * V�rifie que la clef existe dans la table donn�e
     *
     * @param string $key
     * @param string $table
     * @param \PDO $pdo
